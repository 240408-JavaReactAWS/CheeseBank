...
public class TransactionService {
    ...
    // Withdrawal, deposit
    @Transactional(rollbackFor = { UserNotFoundException.class, InsufficientBalanceException.class,
    ...
    @Transactional(readOnly = true)
    public Page<Transaction> getTransactionsByTimeRange(User currentUser, LocalDateTime start, LocalDateTime end,
            Pageable pageable) {
    ...
    @Transactional(readOnly = true)
    public Page<Transaction> getTransactionsByType(User currentUser, TransactionType transactionType,
            Pageable pageable) {
